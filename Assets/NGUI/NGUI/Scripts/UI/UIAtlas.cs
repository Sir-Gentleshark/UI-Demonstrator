...
public class UIAtlas : MonoBehaviour
{
...
#if CRAZYPANDA_UNITYCORE_ATLASGENERATOR
	public virtual Material spriteMaterial
#else
	...
	/// </summary>
#if CRAZYPANDA_UNITYCORE_ATLASGENERATOR
	public virtual List<UISpriteData> spriteList
#else
...
#if CRAZYPANDA_UNITYCORE_ATLASGENERATOR
	public virtual Texture texture { get { return (mReplacement != null) ? mReplacement.texture : (material != null ? material.mainTexture as Texture : null); } }
#else
...
#if CRAZYPANDA_UNITYCORE_ATLASGENERATOR
	public virtual UIAtlas replacement
#else
	...
	/// </summary>
#if CRAZYPANDA_UNITYCORE_ATLASGENERATOR
	public virtual void MarkSpriteListAsChanged()
#else
