...
#else
#if PANDA_SLIM
		GameObject bg = (mBG != null && (mBG.GetComponent<Collider2D>() != null)) ? mBG.gameObject : gameObject;
#else
...
#if PANDA_SLIM
		if (thumb != null && (thumb.GetComponent<Collider2D>() != null) && (mFG == null || thumb != mFG.cachedTransform))
#else
